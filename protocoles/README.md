# Les deux protocoles - lequel employer

Deux méthodes de conduite d'une évolution par un agent LLM. Elles sont **indépendantes** : chacune
...
Compact et standard désignent l’organisation du travail, avec les mêmes exigences de qualité.
...
Les deux formats exigent un attendu vérifiable automatiquement. Un contrôle peut être créé pendant
...
| | compact | standard |
| :--- | :--- | :--- |
| Documents produits | 1 | 4 |
| Pas | 5 | 8 |
| Contrôle mécanique dédié | aucun -- historique Git examiné par l'exécutant | `verifier_documents.py` |
| Relecture des sources avant écriture | oui | oui |
| L'agent peut publier sa branche | selon le régime d'autorisation | selon le régime d'autorisation et les conditions de clôture |
| Lignes à lire avant de commencer | ~350 | ~580 |
